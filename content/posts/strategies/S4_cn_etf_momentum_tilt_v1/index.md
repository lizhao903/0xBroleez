---
title: "A股 ETF 等权 + 动量倾斜 · v1"
date: 2026-05-08T14:12:36+08:00
draft: false
summary: "❌ **搁置 v1**。在 V1 共享基线（6 只宽基/行业 ETF、2020-2024、20 日 lookback、α=1.0、月频再平衡）上，横截面动量倾斜相对 S3 等权基线产生 **-2.56% 年化超额、IR=-0.49、t-stat=-1.08**，统计上未达到显著拒绝零假设，但**所有尝试过的 α 与 lookback 组合方向上一致为负**——属于经济意义上的系统性反向，不是噪音。"
tags: ['策略复盘', 'momentum', 'rebalance', 'tilt', 'etf', 'benchmark_suite_v1']
categories: ["策略复盘"]
...
<br>源码：<a href="https://github.com/lizhao903/Strategy-Lib/tree/main/ideas/S4_cn_etf_momentum_tilt/v1" target="_blank" rel="noopener"><code>ideas/S4_cn_etf_momentum_tilt/v1</code></a> + <a href="https://github.com/lizhao903/Strategy-Lib/tree/main/summaries/S4_cn_etf_momentum_tilt/v1" target="_blank" rel="noopener"><code>summaries/S4_cn_etf_momentum_tilt/v1</code></a>
</div>

<div class="versions-nav">
<div class="versions-nav-title">本策略的其他版本</div>

- <span class="version-tag version-tag-current">v1</span> **本文** ❌ — **搁置 v1**。在 V1 共享基线（6 只宽基/行业 ETF、2020-2024、20 日 lookback、α=1.0、月频再平衡）上，横截面动量倾斜相对 S3 等权基线产生 **-2.56% 年化超额、IR=-0.49、t-stat=-1.08**，统计上未达到显著拒绝零假设，但**所有尝试过的 α 与 lookback 组合方向上一致为负**——属于经济意义上的系统性反向，不是噪音。
- <span class="version-tag version-tag-positive">[v2]({{< relref "/posts/strategies/S4_cn_etf_momentum_tilt_v2/index.md" >}})</span> ✅ — **v2 的改进显著有效**（CAGR +5.73pp / Sharpe ×3.7 / MaxDD 减半 vs v1，且首次跑赢 510300 BH +2.6%/yr），**但收益主要来自「扩池 6 → 11」对 S3 baseline 的提升，动量 tilt 信号本身仍未带来 alpha**（v2 vs S3-11 IR=-0.17，α 敏感性中 α=0 仍是最优档）。**Ship v2 配置**，但备注「价值在跨资产分散，而非动量」；status 为 **shipped (pool value, not factor value)**。
...
![tilt_strength](tilt_strength.png)

![weight_evolution](weight_evolution.png)
...
- [想法 · idea.md](https://github.com/lizhao903/Strategy-Lib/blob/main/ideas/S4_cn_etf_momentum_tilt/v1/idea.md)
- [讨论笔记 · notes.md](https://github.com/lizhao903/Strategy-Lib/blob/main/ideas/S4_cn_etf_momentum_tilt/v1/notes.md)
- [结论 · conclusion.md](https://github.com/lizhao903/Strategy-Lib/blob/main/summaries/S4_cn_etf_momentum_tilt/v1/conclusion.md)
- [实现 · implementation.md](https://github.com/lizhao903/Strategy-Lib/blob/main/summaries/S4_cn_etf_momentum_tilt/v1/implementation.md)
- [验证 · validation.md](https://github.com/lizhao903/Strategy-Lib/blob/main/summaries/S4_cn_etf_momentum_tilt/v1/validation.md)
- [可复跑脚本 · validate.py](https://github.com/lizhao903/Strategy-Lib/blob/main/summaries/S4_cn_etf_momentum_tilt/v1/validate.py)
- [本版本目录（含 artifacts）](https://github.com/lizhao903/Strategy-Lib/tree/main/summaries/S4_cn_etf_momentum_tilt/v1)
